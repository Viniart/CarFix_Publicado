...
namespace CarFix.Project.Controllers
{
    ...
    public class VehiclesController : ControllerBase
    {
        ...
        [Route("My")]
        [HttpGet]
        public IActionResult GetAllMyVehicles()
        {

            try
            {
                Guid idJti = Guid.Parse(HttpContext.User.Claims.FirstOrDefault(c => c.Type == JwtRegisteredClaimNames.Jti).Value);
                return Ok(_unitOfWork.VehicleRepository.ListMyVehicles(idJti));
        ...
        [HttpPatch]
        public IActionResult UpdateVehicle(UpdateVehicleDTO vehicleUpdated)
        {
